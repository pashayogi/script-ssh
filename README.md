```Script Installer UBUNTU servser By :

Github : github.com/pashayogi
Name : script-ssh
Build : ./OiBoy SecLinux

```


Script auto installer VPS untuk mempermudah anda jualan ssh mohon tidak di **perjual belikan** script ini karna anda mendapatkannya secara **GRATIS** 
----------
...
```sh
$ wget https://raw.githubusercontent.com/pashayogi/script-ssh/master/centos-kvm.sh
...
```sh
$ wget https://raw.githubusercontent.com/pashayogi/script-ssh/master/centos-kvm.sh && chmod +x centos-kvm.sh && sh centos-kvm.sh
```
